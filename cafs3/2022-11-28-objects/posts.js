...
function task713(arr) {
  let item = arr[2];
  let title = item.title;
  let body = item.body;

  // console.log(`Post title is: '${arr[2].title}' and the content is: '${arr[2].body}'.`)
