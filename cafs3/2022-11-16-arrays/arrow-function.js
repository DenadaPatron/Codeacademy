...
// Sukuriamas kintamasis ir jam, kaip reikšmę, priskiriama anoniminė funkcija
...
console.log(arrowFunc2(2, 8))

let arrowFunc3 = (num) => {
  return num * num;
}
console.log(arrowFunc3(15));
...
console.log(arrowFunc5(15));

let arrowFunc6 = (num1, num2) => num1 * num2;
console.log(arrowFunc6(5, 5));